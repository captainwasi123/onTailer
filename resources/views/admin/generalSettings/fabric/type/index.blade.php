...
<div class="main-content">
   <div class="content-border m-b-30">
      <div class="page-heading">
         <h3> Add Fabric Type </h3>
      </div>
      <div class="form-1 custom-pad1 m-b-30">
         <form method="post" action="{{route('admin.settings.fabricType.add')}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
               <div class="col-md-5 col-lg-5 col-sm-12 col-12">
                  <div class="form-field2 m-b-30">
                     <input type="text" placeholder="Fabric Type" class="field-style2" name="name" required>
                  </div>
               </div>
                  ...
                  <tbody>
                     @foreach($types as $key => $val)
                        <tr>
                           ...
                           <td class="tab-text4"> <img src="{{URL::to('/public/storage/settings/fabric/type/'.$val->image)}}" onerror="this.onerror=null;this.src='{{URL::to('/public/placeholder-image.png')}}';" height="40px"> </td>
                           <td class="tab-text4"> {{$val->name}} </td>
                           <td class="text-center tab-text4 text-center"> 
                              <a href="javascript:void(0)" class="edit-icon editFabricType" data-id="{{base64_encode($val->id)}}"> 
                                 <i class="fa fa-pencil-alt"> </i> 
                              </a>
                              &nbsp;&nbsp;  
                              <a href="javascript:void(0)" class="del-icon deleteFabricType" data-id="{{base64_encode($val->id)}}"> 
...
<!-- Edit Modal -->
<div id="editFabricTypeModal" class="modal fade" role="dialog">
