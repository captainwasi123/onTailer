<div class="sidebar">
   <div class="sidebar-menu">
      <div id="accordion">
         ...
         <div class="panel panel-default">
            <div class="panel-heading">
               <a href="{{URL::to('/public/admin')}}/"> <img src="{{URL::to('/public/admin')}}/images/menu-icon2.png"> Users </a>
            </div>
         </div>
         <div class="panel panel-default">
            <div class="panel-heading">
               <a href="{{URL::to('/public/admin')}}/"> <img src="{{URL::to('/public/admin')}}/images/menu-icon3.png"> Orders </a>
            </div>
         </div>
         <div class="panel panel-default">
            <div class="panel-heading">
         ...
         <div class="panel panel-default">
            <div class="panel-heading">
               <a href="{{URL::to('/public/admin')}}/"> <img src="{{URL::to('/public/admin')}}/images/menu-icon8.png"> Return & Refund </a>
            </div>
         </div>
         <div class="panel panel-default">
            <div class="panel-heading">
               <a href="{{URL::to('/public/admin')}}/"> <img src="{{URL::to('/public/admin')}}/images/menu-icon9.png"> SEO </a>
            </div>
         </div>
         <div class="panel panel-default">
            <div class="panel-heading">
