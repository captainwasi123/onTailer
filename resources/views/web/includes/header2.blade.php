      ...
      <div class="navbar-header">
        ...
        <div id="sidebar">
            <ul class="main-menu pad-top-40 main-menu-custom">
                ...
                <li><a href=""><i class="fa fa-headphones" aria-hidden="true"></i>Contact Us</a></li>
            </ul>
            <ul class="main-menu pad-top-40 main-menu-custom menu-bottom">
                <li> <a href="javascript:void(0)"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Quick Links</a>
                <div class="sub-menu">
